...
console.log('だからもう\n' +
    ...
    'きらめく橋の向こうまで\n' +
    '一緒に\n');
console.log('%c links  %c https:/// ', 'color: white; background: #e9546b; padding:5px 0;', 'padding:4px;border:1px solid #e9546b;')
...
//location.href = location.href.replace(document.location.host,'p');
//}
